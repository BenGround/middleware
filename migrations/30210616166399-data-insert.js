...
module.exports = {
  up: async (queryInterface, DataTypes) => {
    ...
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (1, 2)')
    ...
    await queryInterface.sequelize.query('insert into Menus (name, restaurantsId, price) values (\'Menu\', 2, 17)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (2, 8)')
    ...
    await queryInterface.sequelize.query('insert into Menus (name, restaurantsId, price) values (\'Menu stylé\', 3, 25)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (3, 14)')
    ...
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (3, 20)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (3, 23)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (3, 24)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (4, 22)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (4, 23)')
    await queryInterface.sequelize.query('insert into MenuArticles (menusId, articlesId) values (4, 24)')
